	...
	public String platoChat(@RequestBody Map map,
		...
		System.out.println(map);
		  ...
		  List<chatbotDTO> keyResult = (List) mapmap.get("keyResult");		
			...
			/*
			 * int count = Math.min(keyResult.size(), 3); for (int i = 0; i < count; i++) {
			 * chatbotDTO listdto = keyResult.get(i); String title = listdto.getTitle(); int
			 * postid = listdto.getPostid(); String url =
			 * "http://1.222.90.55:8007/recipe?postid=" + postid; String mnpp =
			 * dto.getMnp(); String mnp = "http://1.222.90.55:8007/" + mnpp; }
			 */
